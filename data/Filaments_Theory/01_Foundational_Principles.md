...
المقدمة: أزمة السببية في الفيزياء المعاصرة
...
مظاهر الأزمة:
استبدال الآليات بالمبادئ المجردة: لقد استبدلنا الآليات المادية المفهومة بالمبادئ الرياضية المجردة
التفردات الحسابية: نماذجنا الكونية تبدأ من "تفرد" حسابي لا يمكن تفسيره فيزيائياً
الظواهر الكمومية الغامضة: نظرياتنا تصف "انهيار" الدالة الموجية دون تقديم آلية فيزيائية
الثوابت الحرة: الثوابت الأساسية يتم إدخالها كـ "معاملات حرة" دون تفسير سببي
...
النتائج الحتمية:
آلية الاستقطاب: الطريقة الوحيدة لنشوء "شيء" من "الصفر" هي عبر استقطاب إلى ماهيتين متضادتين:
 $$0 \equiv (+a) + (-a)$$
مبدأ عدم الدين الكوني: أي شيء ينشأ، يجب أن ينشأ معه نقيضه المساوي والمعاكس
...
النتائج الحتمية:
التعامد الإجباري: لكي تبقى الماهيتان المتضادتان موجودتين دون إفناء بعضهما، يجب أن تكونا متعامدتين:
 $$\vec{a}+ \cdot \vec{a}- = 0$$
الحلقية الإجبارية: الشكل الوحيد الذي يحترم التناظر المطلق هو الحلقة الدائرية
...
الفتيلة الأولية: التجسيد الحتمي للمبادئ
...
اشتقاق الثوابت الكونية من المبادئ الأولى
...
كتلة الفتيلة الأولية ($m0$) هي بالضبط كتلة بلانك ($mP$)
امتدادها المكاني ($r0$) هو طول بلانك ($lP$)
...
$$\boxed{p0 \cdot r0 = \hbar}$$

ربط الزخم بالكتلة:
من النسبية الخاصة: $p0 = m0 c$

دمج المعادلتين:
$$m0 c \cdot r0 = \hbar \implies \boxed{m0 = \frac{\hbar}{c r0}}$$
...
$$\boxed{r0 \equiv lP = \sqrt{\frac{\hbar G}{c^3}}}$$

النتيجة الحاسمة:
$$m0 = \frac{\hbar}{c \cdot lP} = \sqrt{\frac{\hbar c}{G}} \equiv m_P$$

$$\boxed{m0 = \sqrt{\frac{\hbar c}{G}} \equiv mP}$$
...
$$\boxed{r0 = \sqrt{\frac{\hbar G}{c^3}} \equiv lP}$$

4.4 التحقق من الاتساق الداخلي

اختبار الاتساق:
$$mP \cdot c \cdot lP = \left(\sqrt{\frac{\hbar c}{G}}\right) \cdot c \cdot \left(\sqrt{\frac{\hbar G}{c^3}}\right) = \hbar$$

$$\boxed{mP c lP = \hbar \quad \checkmark}$$

هذا يبرهن على أن النموذج متسق داخلياً بشكل كامل.

الإطار الرياضي الرسمي: اللاغرانجيان الفتيلي

5.1 تعريف الحقل الفتيلي

نقدم الكيان الديناميكي الأساسي، الحقل الفتيلي ($\Phi$)، وهو حقل قياسي مركب:

$$\mathcal{L}{FFT} = (\partial\mu \Phi^*)(\partial^\mu \Phi) - V(\Phi)$$
...
لقد نجحنا في:
تأسيس مبادئ أولى منطقية: انطلقنا من مسلّمتين بسيطتين لا يمكن إنكارهما
اشتقاق البنية الحتمية للواقع: برهنّا أن الفتيلة الأولية هي النتيجة الحتمية للمبادئ
توحيد الثوابت الأساسية: أثبتنا أن $\hbar$, $c$, $G$ مظاهر مترابطة لخصائص الفتيلة
تطوير إطار رياضي رسمي: قدمنا اللاغرانجيان الفتيلي كأساس للحسابات
...
$$\boxed{\begin{align}
m0 &= mP = \sqrt{\frac{\hbar c}{G}} \
r0 &= lP = \sqrt{\frac{\hbar G}{c^3}} \
m0 c r0 &= \hbar
\end{align}}$$
