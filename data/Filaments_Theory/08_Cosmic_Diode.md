...
المقدمة: إعادة النظر في طبيعة الاتجاه في الكون
...
الأساس النظري: كسر التناظر وولادة الاتجاهية
...
$$\boxed{\vec{D}{\text{cosmic}} = \frac{\nabla \rho{\text{contractive}}}{|\nabla \rho_{\text{contractive}}|}}$$
...
الآلية الفيزيائية: الامتصاص الاتجاهي
...
الآلية:
الأرض (كتلة كبيرة) تشبع المنطقة المحيطة بالماهية الانطوائية
هذا يخلق "تدرج اتجاهي" في خصائص الفضاء
الأجسام تتبع هذا التدرج تلقائياً (مثل الكرة تتدحرج نحو أسفل المنحدر)
...
$$\boxed{F{\text{tidal}} = \frac{\partial F{\text{diode}}}{\partial r} \Delta r}$$
...
$$\frac{E{\text{up}}}{E{\text{down}}} = 1 + \delta_{\text{diode}}$$
...
التنبؤ:
$$\boxed{|\vec{F}{12}| \neq |\vec{F}{21}| \text{ في وجود كتلة ثالثة كبيرة}}$$

السبب: الدايود الكوني يكسر التماثل المثالي.

التقدير:
$$\frac{\Delta F}{F} \sim 10^{-12} \frac{M{\text{third}}}{M{\text{Earth}}} \frac{R_{\text{Earth}}}{d}$$
...
التوقيع المميز:
$$\boxed{\rho{\text{vacuum}}(r, t) = \rho0 \left[1 - \alpha \frac{M}{r} + \beta \cos(\omega t)\right]}$$

6.4 تأثيرات الاتجاه على الزمن

التنبؤ: الزمن يمر بشكل مختلف قليلاً حسب اتجاه الحركة

$$\boxed{\frac{dt{\text{toward}}}{dt{\text{away}}} = 1 + \gamma \frac{GM}{rc^2}}$$
...
التقدير:
$$F{\text{thrust}} = \alpha \frac{dM{\text{artificial}}}{dt}$$
...
لقد نجحنا في:
تقديم مفهوم ثوري للخاصية الاتجاهية للواقع
تفسير أصل التعجيل الجذبوي من مبادئ أولى
حل ألغاز الجاذبية الكلاسيكية بطريقة سببية
تطوير نموذج رياضي قابل للاختبار

10.2 التحدي القادم

المرحلة التالية:
تصميم تجارب دقيقة لكشف التأثيرات الاتجاهية
تطوير تقنيات لاستغلال الدايود الكوني
دمج المفهوم مع باقي نظرية الفتائل
