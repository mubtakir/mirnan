...
الأساس النظري: الفضاء الفتيلي والإشغال
...
$$\boxed{E{\text{tension}} = \sum{i,j} J{ij} \Omega(i) \Omega(j) + \sumi V_i \Omega(i)}$$
...
طيف كتل الجسيمات من الأعداد الأولية

4.1 الربط بين الكتلة والإشغال

$$\boxed{mp = \alpha \cdot E{\text{tension}}(p) + \beta}$$
...
بوزون هيغز يرتبط بـأكبر عدد أولي في النطاق الطاقي المتاح (حتى ~1 TeV)، وهو 127.

$$\boxed{mH = \alpha \cdot E{\text{tension}}(127) + \beta \approx 125.1 \text{ GeV}}$$

قانون الإشغال الكوني

قانون الإشغال الكوني:

$$\boxed{P(n) = \frac{\Omega(n)}{\sum{k=1}^{N} \Omega(k)} \cdot \exp\left(-\frac{E{\text{tension}}(n)}{kB T{\text{eff}}}\right)}$$
